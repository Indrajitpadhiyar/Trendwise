...
function Navbar() {
    ...
    return (
        <div className='flex flex-wrap justify-between items-center w-full'>
            <div className="logo">
                <h4
                    onClick={() => Navgate('/home')}
                    className='text-blue-500 text-4xl mt-10 ml-10 font-bold hover:cursor-pointer'>Tredwise</h4>
            </div>
            <div className='flex flex-wrap items-center'>
                ...
                <div>
                    <button
                        ...
                        className='border-2 flex items-center border-white text-white mt-10 mr-10 font-semibold px-4 py-1 rounded-xl hover:bg-white hover:text-black transition ease-in-out duration-300'>
                        Get Start
